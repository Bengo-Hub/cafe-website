...
echo ""
echo "To create the cafe-website-env, run:"
echo ""
echo "kubectl create secret generic $SECRET_NAME \\"
echo "  --from-literal=NEXT_PUBLIC_MAPBOX_TOKEN='YOUR_MAPBOX_TOKEN' \\"
echo "  --from-literal=NEXT_PUBLIC_SENTRY_DSN='YOUR_SENTRY_DSN' \\"
echo "  -n $NAMESPACE"
echo ""
...
echo ""
echo "Next steps:"
echo "1. Create secrets (optional): kubectl create secret generic cafe-website-env ..."
